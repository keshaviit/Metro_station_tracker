      ...
      <main className="pt-24 px-margin-mobile max-w-2xl mx-auto space-y-xl">
        ...
        <section className="glass-panel border border-outline-variant/30 rounded-xl p-md soft-shadow relative z-10 space-y-md">
          ...
          <div className="flex flex-col gap-sm">
            ...
            <button
              id="home-buy-qr-ticket-btn"
              onClick={buyOfficialMetroTicket}
              className="w-full h-14 bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white-force rounded-xl font-title-md text-title-md shadow-lg flex items-center justify-center gap-3 active:scale-[0.98] transition-all font-bold uppercase tracking-wider"
            >
