...
export default function AuthPage() {
  ...
  return (
    <div className="bg-gradient-to-b from-[#F6FBF7] via-[#fcf8ff] to-[#f4f7fc] font-body-lg text-on-background min-h-screen flex items-center justify-center p-md relative w-full overflow-y-auto">
      ...
      <main className="w-full max-w-[420px] flex flex-col items-center py-8">
        ...
        <div className="w-full bg-white border border-gray-100 rounded-[28px] p-8 shadow-[0_8px_30px_rgba(0,0,0,0.03)] relative">
          ...
          <div className="flex flex-col items-center text-center mb-8">
            <div className="w-20 h-20 rounded-full bg-[#4CAF50] flex items-center justify-center text-white mb-6 shadow-[0_4px_12px_rgba(76,175,80,0.15)]">
          ...
          {!showCredForm && !showOtpScreen ? (
            ...
            <div className="flex flex-col gap-4">
              <button 
                ...
                className="w-full h-12 bg-[#4CAF50] hover:bg-[#388E3C] text-white rounded-full font-bold text-[15px] shadow-sm hover:shadow transition-all active:scale-[0.98] flex items-center justify-center"
              >
                Sign In
              </button>
              ...
              <button 
                ...
                className="w-full h-12 bg-white border border-gray-200 hover:border-gray-300 text-[#4CAF50] rounded-full font-bold text-[15px] transition-all active:scale-[0.98] flex items-center justify-center"
              >
                Continue as Guest
              </button>
            </div>
            ...
            <form onSubmit={handleOtpSubmit} className="flex flex-col gap-6">
              ...
              <div className="flex justify-center gap-2" onPaste={handleOtpPaste}>
                {otpDigits.map((digit, idx) => (
                  <input
                    ...
                    className="w-11 h-12 bg-gray-50 border border-gray-200 focus:border-[#4CAF50] focus:ring-2 focus:ring-[#4CAF50]/20 rounded-xl text-center text-[18px] font-bold text-gray-800 outline-none transition-all font-mono"
                    required
                  />
                ))}
              </div>
              ...
              <button 
                type="submit" 
                disabled={loading}
                className="w-full h-12 bg-[#4CAF50] hover:bg-[#388E3C] text-white rounded-full font-bold text-[15px] shadow-sm transition-all active:scale-[0.98] flex items-center justify-center"
              >
                {loading ? (
              ...
              <div className="flex flex-col items-center gap-2 pt-2 text-center">
                {canResend ? (
                  ...
                  <span className="text-xs text-gray-400">
                    Resend passcode in <span className="font-bold text-[#4CAF50]">{resendTimer}s</span>
                  </span>
                )}
            ...
            <form onSubmit={handleSendOtp} className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1.5 text-left">
                ...
                <div className="relative group">
                  <span className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-[#4CAF50] transition-colors text-[20px]">mail</span>
                  <input 
                    type="email"
                    id="email"
                    value={email}
                    ...
                    className="w-full h-12 pl-12 pr-4 bg-gray-50 border border-gray-200 focus:border-[#4CAF50] focus:ring-2 focus:ring-[#4CAF50]/20 rounded-xl outline-none transition-all text-[15px] text-gray-800"
                    required
                  />
                </div>
              </div>
