            ...
            <div className="space-y-3">
              <div className="flex gap-md">
                <button 
                  ...
                  className="flex-1 h-14 bg-[#00b050] hover:bg-[#009940] text-white rounded-full font-title-md text-title-md shadow-lg shadow-primary/20 flex items-center justify-center gap-sm active:scale-[0.98] transition-all font-bold text-white-force uppercase tracking-wider"
                >
              ...
              <button
                ...
                className="w-full h-14 bg-[#009688] hover:bg-[#00796B] text-white-force rounded-full font-title-md text-title-md shadow-lg flex items-center justify-center gap-3 active:scale-[0.98] transition-all font-bold uppercase tracking-wider"
              >
