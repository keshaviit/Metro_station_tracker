          ...
          <div className="px-margin-mobile pb-10">
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full h-14 bg-[#009688] hover:bg-[#00796B] text-white-force rounded-full font-title-md text-title-md shadow-lg flex items-center justify-between px-4 active:scale-[0.98] transition-all font-bold uppercase tracking-wider"
              >
                <div className="w-8 flex items-center justify-start flex-shrink-0">
