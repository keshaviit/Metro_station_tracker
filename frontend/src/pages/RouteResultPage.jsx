      ...
      <div className="px-4 py-5 space-y-4 animate-fade-in relative z-10">
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            disabled={starting}
            className="w-full h-14 bg-[#00b050] hover:bg-[#009940] text-white rounded-full font-bold text-[12px] sm:text-[14px] shadow-md flex items-center justify-between px-4 active:scale-[0.98] transition-all disabled:opacity-70 uppercase tracking-wider text-white-force"
          >
