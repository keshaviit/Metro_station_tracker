      ...
      <div className="px-4 py-5 space-y-4 animate-fade-in relative z-10">
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className="flex-1 h-14 bg-[#009688] hover:bg-[#00796B] text-white rounded-full font-bold text-[13px] sm:text-[14px] shadow-md flex items-center justify-center gap-2 active:scale-[0.98] transition-all uppercase tracking-wider text-white-force"
          >
          ...
          <button
            ...
            disabled={starting}
            className="flex-1 h-14 bg-[#00b050] hover:bg-[#009940] text-white rounded-full font-bold text-[13px] sm:text-[14px] shadow-md flex items-center justify-center gap-2 active:scale-[0.98] transition-all disabled:opacity-70 uppercase tracking-wider text-white-force"
          >
            ...
            <span className="font-bold text-[16px] text-white-force ml-0.5">&gt;</span>
          </button>
        </div>
      </div>
    </div>
